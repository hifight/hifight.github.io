...
permalink: /footsies-privacy/
---
 <head> <title>Privacy Policy</title> 
 <style>body{font-family: "Helvetica Neue", Helvetica, Arial, sans-serif; padding:1em;}</style>
 </head> 
 <body><h2>Privacy Policy</h2> 
 <p> HiFight built the FOOTSIES app as an Ad Supported app. 
 This SERVICE is provided by HiFight at no cost and is intended for use as is.
</p>
...
at FOOTSIES unless otherwise defined in this Privacy Policy.
...
<ul><li><a href="https://unity3d.com/legal/privacy-policy" target="_blank">Unity Privacy Policy</a></li> <!----> <!----> <!----> <!----> <!----></ul>

</div> <p><strong>Log Data</strong></p> <p> I want to inform you that whenever you use my Service, in a case of an
